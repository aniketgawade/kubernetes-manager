...
class KubeManagerEmergencyLog(sandesh_base.SandeshSystem):
...
class KubeManagerAlertLog(sandesh_base.SandeshSystem):
...
class KubeManagerCriticalLog(sandesh_base.SandeshSystem):
...
class KubeManagerErrorLog(sandesh_base.SandeshSystem):
...
class KubeManagerWarningLog(sandesh_base.SandeshSystem):
...
class KubeManagerNoticeLog(sandesh_base.SandeshSystem):
...
class KubeManagerInfoLog(sandesh_base.SandeshSystem):
...
class KubeManagerDebugLog(sandesh_base.SandeshSystem):
